...
#ifndef ADCSENSORSTASK_H_
#define ADCSENSORSTASK_H_
// ****************************************************************************
...
class ADCSensorsTask : public AppTask
{
    // ------------------------------------------------------------------------
public:
    ADCSensorsTask(const std::string name,
               DataItemId id,
               Logger* pLog,
               const std::string type,
               double sampleFreq,
               double reportPeriod);
    virtual ~ADCSensorsTask();
...
private:
    ...
    DataItem<double> *pAmbientLight;
    DataItem<double> *pPwr5v;
    DataItem<double> *pPwr3p3v;
